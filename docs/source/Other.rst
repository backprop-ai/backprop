...
See the `Q&A <https://github.com/kiri-ai/kiri/blob/main/examples/core/Q%26A.ipynb>`_ examples with code.
...
Check the example `zero-shot classification <https://github.com/kiri-ai/kiri/blob/main/examples/core/Classification.ipynb>`_ with code.
...
See `sentiment detection <https://github.com/kiri-ai/kiri/blob/main/examples/core/Sentiment.ipynb>`_ with code.

Text Summarization
------------------
Also self-explanatory: takes a chunk of input text, and gives a summary of key information.

See the example for `text summarization <https://github.com/kiri-ai/kiri/blob/main/examples/core/Summary.ipynb>`_ with code.